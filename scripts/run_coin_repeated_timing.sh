...
OUT_ROOT="${OUT_ROOT:-runs/efficiency/coin_repeated_exclusive}"
...
run_point coin coin 0.40 1

run_point scope scope 0.40 2
run_point coin coin 0.40 2
...
run_point coin coin 0.40 3
run_point scope scope 0.40 3
run_point full grid 1.00 3

python scripts/build_coin_repeated_timing_report.py --runs-root "${OUT_ROOT}" --warmup 5
