...
INDEX_DIR="${INDEX_DIR:-runs/textocr_deletion_restoration/internvl_soft50_indices}"
OUT_ROOT="${OUT_ROOT:-runs/textocr_deletion_restoration/internvl_soft50_runs}"
...
echo "InternVL TextOCR-Hard deletion/restoration queue completed."
